...
import com.lxkj.entity.CreditOrder;
import com.lxkj.entity.Order;
import com.lxkj.mapper.CreditOrderMapper;
        ...
        try (input; Workbook workbook = WorkbookFactory.create(input)) {
            ...
            for (int sheetIndex = 0; sheetIndex < workbook.getNumberOfSheets(); sheetIndex++) {
                ...
                for (int rowIndex = 1; rowIndex <= sheet.getLastRowNum(); rowIndex++) {
                    ...
                    CreditOrder order = this.getOne(Wrappers.<CreditOrder>query().eq("sequence",formatCell(sequence).trim()));
                    if(order==null){
